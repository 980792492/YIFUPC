...
//		组件 初始化时获取被禁言用户列表
		this.api = new Api()
//		获取禁言列表
		this.getnospeechlist(this.vipRoomId)
	},
	methods:{
...
//	    对选中的禁言用户解禁
	...
	computed:{
    	...mapGetters(['roomData','roomId', 'authToken', 'topicId', 'teacherId', '', 'goodsData', 'nospeechlist', 'vipRoomId'])
	}
...
<style lang="less" scoped>
	.no_speech_wrap { padding: 10px 20px;
		.my_group { height: 190px; overflow-y: scroll; padding: 15px 0;
